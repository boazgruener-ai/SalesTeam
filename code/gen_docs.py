...
doc.add_paragraph(
    ...
    "starter set of confirmed countries/industries. Phases 4-8 (the resumable scan queue, the actual "
    "company/contact discovery scan modules, merging into the workbook, and AI prioritization) remain "
    "unbuilt."
)
...
doc.add_paragraph(
    "See RELEASE_NOTES.md for the full, dated changelog. Current version: 0.31.0."
)
